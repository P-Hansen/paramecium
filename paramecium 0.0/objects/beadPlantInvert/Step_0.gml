...
if (hp >= maxHp && growthFlag == false && instance_number(beadPlantInvert) < 1000 && instance_number(beadPlant) < 1000) {
	roll = random_range(1,100);
	if(roll >= 97) {
		baby = instance_create_depth(x, y, 0, choose(beadPlantMasterInvert));
