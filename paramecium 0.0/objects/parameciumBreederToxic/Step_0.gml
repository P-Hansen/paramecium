...
if(instance_exists(enemy) && point_distance(x, y, enemy.x, enemy.y) <= sightRange) && ammo > 0 {
	speed = 1;
	...
	poison.direction = point_direction(x,y, enemy.x, enemy.y);
	poison.speed = random_range(1,3);
	ammo -= 1;
}
